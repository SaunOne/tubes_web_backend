...
<div class="container flex px-4 py-2">
    ...
    <div class="container px-4 py-2 border border-info my-4 rounded border-2">
        <h1>
            Edit Data
        </h1>
        <div class="row my-2">
        ...
        <button type="submit" class="btn btn-warning btn-block mb-4 btn-custom px-3">Save Changes</button>
        <button type="submit" class="btn btn-danger btn-block mb-4 px-3 justify-content-end">Delete User</button>
    </div>
</div>
@endsection