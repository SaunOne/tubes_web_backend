        ...
        <div class="row">
            <div class="col-xxl-5">
                <div class="container cont-img">
                    ...
                    <p class="mt-5"><strong>Alamat: </strong>Jl. babarsari yogyakarta indonesia singapura, di sebalah
            ...
            <div class="d-none row d-sm-flex mt-5 mb-5">
                ...
                <div class="col d-flex justify-content-center align-items-center">
                    <div class="home-content4">
                        <a href="{{ url('paymentKiloan') }}" class="img-ly1"><img src="{{ asset('images/imgly1.png') }}" alt=""></a>
                        <div>
                            <h4>Kiloan</h4>
                        </div>
                    </div>
                ...
                <div class="col d-flex justify-content-center align-items-center">
                    <div class="home-content4">
                        <a href="{{ url('pilihLayanan') }}" class="img-ly3"><img src="{{ asset('images/imgly3.png') }}" alt=""
            ...
            <div id="carouselExample" class="carousel slide">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <div class="home-content4">
                            <a href="{{ url('paymentKiloan') }}" class="img-ly1"><img src="{{asset('images/imgly1.png')}}" alt="" style="height: 150px;"></a>
                            <div>
                                <h4>Kiloan</h4>
                            </div>
                        </div>
                    ...
                    <div class="carousel-item">
                        <div class="home-content4">
                            <a href="{{ url('pilihLayanan') }}" class="img-ly3"><img src="{{asset('images/imgly3.png')}}" alt="" style="height: 150px;"></a>
                            <div>
                                <h4>Antar Jemput</h4>
                            </div>
                        </div>
