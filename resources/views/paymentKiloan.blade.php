    ...
    <div class="container mt-5">
        <div class="row">
            <div class="col-xl-8 cont-1">
                <div class="container-xxl cont-payment mt-5 mb-5">
                    <div class="row">
            ...
            <div class="col-xl-4 cont-2">
                <div class="container-xxl cont-table mt-5" style="padding-left: 0; padding-right: 0;">
                    <table class="table">
                        <thead>
                            <tr class="table-info">
